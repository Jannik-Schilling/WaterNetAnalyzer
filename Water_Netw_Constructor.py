...
"""
ToDo remove support prior to 3.38
"""
...
if qgis_version_info[0] == 4:
    qgis_4_x = True
    processing_package = QgsProcessing.SourceType
    processing_param_field_package = QgsProcessingParameterField.DataType
    processing_param_flag_package = QgsProcessingParameterDefinition.Flag
    q_meta_type = QMetaType.Type
else:
    qgis_4_x = False
    processing_package = QgsProcessing
    processing_param_field_package = QgsProcessingParameterField
    processing_param_flag_package = QgsProcessingParameterDefinition
    q_meta_type = QMetaType
...
class WaterNetwConstructor(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        self.addParameter(
            QgsProcessingParameterVectorLayer(
                ...
                [processing_package.TypeVectorLine]
            )
        )
        ...
        self.addParameter(
            QgsProcessingParameterField(
                ...
                type = processing_param_field_package.Any,
                optional = True
            )
        )
        ...
        param_Radius.setFlags(param_Radius.flags() | processing_param_flag_package.FlagAdvanced)
        ...
        param_multiple_netw.setFlags(param_multiple_netw.flags() | processing_param_flag_package.FlagAdvanced)
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        for field in raw_fields:
            ...
            out_fields.append(QgsField('NET_ID', q_meta_type.QString))
            out_fields.append(QgsField('NET_TO', q_meta_type.QString))
            out_fields.append(QgsField('NET_FROM', q_meta_type.QString))
